...
public class DefaultVocab {
    ...
    public static final String [] definitionGRE = {
            ...
            "n: person who flatter to the rich and powerful",
            "n: summary or outline",
            "adj: silent",
            "n: form of a frog when it leaves the egg",
            "n: one of the sharp claws on the feet of some birds",
            "v: tap or drive down by repeated light blows",
            "v: interfere with",
            "adj: suddenly changeable",
            "v: lost brightness",
            "n: bunch of threads",
            "n: contemptuous reproach; hurtful remark",
            "adj: very tight from being pulled or stretched",
            "n: a repetition; a redundancy",
            "adj: morally low or bad",
            "adj: total; complete",
            "n: boldness; brashness",
            "n: the practice of drinking little or no alcohol",
            "adj: emotionally calm and controlled",
            "adj: firmness; tending to hang on",
            "adj: insubstantial; flimsy; weak",
            "adj: lukewarm",
            "adj: brief and to the point",
            "n: witness; evidence",
            "adj: economy thriving; prosperous",
            "v: obstruct; frustrate",
            "adj: shy; easily frightened",
            "adj: fearful; timid; afraid",
            "n: obsequious flatterer",
            "adj: something giving strength or energy",
            "v: be unsteady and overturn",
            "n: severe pain or suffering",
            "adj: not active",
            "n: a turning or twisting force",
            "adj: devious; not straightforward",
            "n: person who worries others to buy something",
            "adj: easily controlled or guided",
            "v: break; go beyond",
            ...
            "adj: unimportant",
            "adj: not new",
            "n: agreement to stop fighting for a time",
            "n: aggressiveness; ferocity",
            "v: walk heavily",
            "adj: not clean or clear",
            "n: a state of confusion, violence, or disorder",
            "adj: excessively ornate, swollen, or bloated",
            "n: trouble; disturbance",
            "n: wickedness; shamefulness",
            "n: greenish-blue precious stone",
            "n: beginner",
            "adj: present everywhere",
            "adj: situated beyond",
            "n: offense; resentment",
            "adj: rough; awkward",
            "v: make a lower bid than somebody else",
            "v: to move in wavelike fashion; fluctuate",
            "v: discover and bring to light",
            "adj: easy going; trifle",
            "adj: not pretended; sincere",
            "adj: unharmed; unhurt",
            "adj: unfortunate; inconvenient",
            "v: to speak in an angry or critical way to",
            "adj: elegant and refined in manners",
            "adj: being uncertain; hesitating",
            "n: strange act or idea",
            ...
            "adj: fresh and green",
            "adj: true or real",
            "n: spirit; vigor; enthusiasm",
            "n: trace or sign",
            "n: annoy; distress; trouble",
            "n: watchfulness",
            "adj: carefully noticing problems or signs of danger",
            "adj: strong; energetic",
            "v: slander; say evil things",
            "adj: intended for or involving revenge",
            "adj: of the internal organs of the body",
            "v: lower the quality; weaken the strength",
            "v: curse; abuse in words",
            "adj: unstable",
            "n: fluency",
            "adj: fluent",
            "v: talk vaguely and without much result",
            "v: to move lightly through the air",
            "v: to move something from side to side repeatedly",
            "n: person who stirs up war",
            "n: authority written order",
            "v: measure how heavy something is",
            "adj: full of odd and fanciful ideas",
            "v: show bodily or mental pain",
            "v: to try to make someone love you",
            "n: written order",
            "n: an exiting or interesting story"
    };
}
